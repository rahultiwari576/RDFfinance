        ...
        <div class="modal-content loan-modal-content">
            ...
            <div class="modal-body">
                <form id="loanApplicationForm"
                    action="<?php echo e(route('loans.apply')); ?>"
                    data-list-url="<?php echo e(route('loans.list')); ?>"
                    data-calculate-url="<?php echo e(route('emi.calculate')); ?>">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="mb-4 mt-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" 
                                   ...
                                   class="form-control loan-input" 
                                   min="0" 
                                   placeholder="Defaults to ₹<?php echo e(config('loan.default_penalty', 100)); ?>">
                            <span class="input-group-text">₹</span>
                        </div>
                        <small class="text-muted">Leave empty to use default penalty of ₹<?php echo e(config('loan.default_penalty', 100)); ?></small>
                    </div>
...
<?php /**PATH D:\ARTtoframe_rahul\finance\resources\views/partials/loan-modal.blade.php ENDPATH**/ ?>