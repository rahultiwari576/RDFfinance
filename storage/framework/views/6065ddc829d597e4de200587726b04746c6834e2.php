        ...
        <div class="auth-card">
            ...
            <div class="tab-content auth-tab-content" id="loginTabsContent">
                ...
                <div class="tab-pane fade show active" id="email-login" role="tabpanel">
                    <form id="emailLoginForm" action="<?php echo e(route('login.email')); ?>" class="auth-form">
                        <?php echo csrf_field(); ?>
                ...
                <div class="tab-pane fade" id="aadhar-login" role="tabpanel">
                    <form id="aadharLoginForm" action="<?php echo e(route('login.aadhar')); ?>" class="auth-form">
                        <?php echo csrf_field(); ?>
                        <div class="form-group">
                    ...
                    <!-- OTP Verification -->
                    <form id="otpVerificationForm" action="<?php echo e(route('login.otp')); ?>" class="auth-form mt-4 d-none" id="otpForm">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\ARTtoframe_rahul\finance\resources\views/auth/login.blade.php ENDPATH**/ ?>