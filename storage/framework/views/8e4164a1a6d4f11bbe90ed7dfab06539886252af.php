...
<?php $__env->startSection('title', 'Smart EMI Calculator'); ?>
                    ...
                    <div class="col-lg-6">
                        <div class="card shadow-lg border-0 calculator-card">
                            <div class="card-body p-4">
                                ...
                                <form id="guestEmiForm" action="<?php echo e(route('emi.calculate')); ?>">
                                    <?php echo csrf_field(); ?>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="input-group input-group-lg">
                                            ...
                                            <input type="number" 
                                                   ...
                                                   class="form-control form-control-lg" 
                                                   min="0" 
                                                   placeholder="Default ₹<?php echo e(config('loan.default_penalty', 100)); ?>"
                                                   value="<?php echo e(config('loan.default_penalty', 100)); ?>">
                                        </div>
...
<script src="<?php echo e(mix('js/emi-calculator.js')); ?>"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\ARTtoframe_rahul\finance\resources\views/emi-calculator.blade.php ENDPATH**/ ?>