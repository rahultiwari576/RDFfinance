...
<div class="auth-container">
    <div class="auth-wrapper register-wrapper">
        <div class="auth-card register-card">
            ...
            <form id="registrationForm" action="<?php echo e(route('register.submit')); ?>" data-extract-url="<?php echo e(route('register.extract-aadhar')); ?>" enctype="multipart/form-data" class="auth-form">
                <?php echo csrf_field(); ?>
...
<script src="<?php echo e(mix('js/registration.js')); ?>"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\ARTtoframe_rahul\finance\resources\views/auth/register.blade.php ENDPATH**/ ?>