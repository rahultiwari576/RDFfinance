...
<div class="row g-4">
    <div class="col-lg-4">
        <div class="card shadow-sm">
            <div class="card-header d-flex justify-content-between align-items-center">
                <span>Profile</span>
                <span class="badge bg-<?php echo e($user->isAdmin() ? 'danger' : 'primary'); ?>"><?php echo e(ucfirst($user->role)); ?></span>
            </div>
            <div class="card-body">
                <p class="mb-1"><strong>Name:</strong> <?php echo e($user->name); ?></p>
                <p class="mb-1"><strong>Email:</strong> <?php echo e($user->email); ?></p>
                <p class="mb-1"><strong>Aadhar:</strong> <?php echo e($user->aadhar_number); ?></p>
                <p class="mb-1"><strong>PAN:</strong> <?php echo e($user->pan_number); ?></p>
                <p class="mb-1"><strong>Phone:</strong> <?php echo e($user->phone_number); ?></p>
                <?php if($user->address): ?>
                    <p class="mb-1"><strong>Address:</strong> <?php echo e($user->address); ?></p>
                <?php endif; ?>
                <?php if($user->city || $user->state): ?>
                    <p class="mb-1"><strong>Location:</strong> <?php echo e(trim(($user->city ?? '') . ', ' . ($user->state ?? ''), ', ')); ?></p>
                <?php endif; ?>
                <?php if($user->profession): ?>
                    <p class="mb-1"><strong>Profession:</strong> <?php echo e($user->profession); ?></p>
                <?php endif; ?>
                <div class="mt-3">
                    <a href="<?php echo e(route('profile.edit')); ?>" class="btn btn-sm btn-primary w-100">Edit Profile</a>
                </div>
            </div>
        </div>
        <div class="card shadow-sm mt-3">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <a class="btn btn-link btn-sm" href="<?php echo e(route('emi.guest')); ?>">Smart EMI Calculator</a>
            </div>
            <div class="card-body">
                <?php if($user->isAdmin()): ?>
                    <a href="<?php echo e(route('admin.dashboard')); ?>" class="btn btn-danger w-100 mb-2">Admin Dashboard</a>
    ...
    <div class="col-lg-8">
                    ...
                    <div class="col-md-3 col-6">
                        <div class="card bg-primary text-white summary-card loan-summary-card h-100">
                            <div class="card-body text-center d-flex flex-column justify-content-center">
                                ...
                                <h3 class="mb-0 fw-bold">₹<?php echo e(number_format($loanSummary['total_principal'], 2)); ?></h3>
                    ...
                    <div class="col-md-3 col-6">
                        <div class="card bg-success text-white summary-card loan-summary-card h-100">
                            <div class="card-body text-center d-flex flex-column justify-content-center">
                                ...
                                <h3 class="mb-0 fw-bold">₹<?php echo e(number_format($loanSummary['total_repayment'], 2)); ?></h3>
                    ...
                    <div class="col-md-3 col-6">
                        <div class="card bg-warning text-dark summary-card loan-summary-card h-100">
                            <div class="card-body text-center d-flex flex-column justify-content-center">
                                ...
                                <h3 class="mb-0 fw-bold">₹<?php echo e(number_format($loanSummary['pending_amount'], 2)); ?></h3>
                    ...
                    <div class="col-md-3 col-6">
                        <div class="card bg-info text-white summary-card loan-summary-card h-100">
                            <div class="card-body text-center d-flex flex-column justify-content-center">
                                ...
                                <h3 class="mb-0 fw-bold"><?php echo e($loanSummary['pending_installments']); ?></h3>
        ...
        <div class="card shadow-sm mb-3">
            ...
            <div class="card-body" id="loansContainer" data-is-admin="<?php echo e($user->isAdmin() ? 'true' : 'false'); ?>" data-list-url="<?php echo e(route('loans.list')); ?>">
        ...
        <div class="card shadow-sm">
            ...
            <div class="card-body" id="remindersContainer" data-url="<?php echo e(route('loans.reminders')); ?>">
...
<?php else: ?>
    <?php echo $__env->make('partials.loan-modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\ARTtoframe_rahul\finance\resources\views/home.blade.php ENDPATH**/ ?>