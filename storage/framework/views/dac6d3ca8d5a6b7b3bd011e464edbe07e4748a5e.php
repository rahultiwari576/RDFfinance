                        ...
                        <table class="table table-hover">
                            ...
                            <tbody id="companiesTableBody">
                                ...
                                <tr data-company-id="<?php echo e($company->id); ?>">
                                    ...
                                    <td>
                                        <span class="badge bg-info"><?php echo e($company->activeModels->count()); ?> models</span>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <button class="btn btn-sm btn-primary edit-company" 
                                                ...
                                                data-active="<?php echo e($company->is_active); ?>">
                                            <i class="bi bi-pencil"></i>
                                        </button>
                                        <button class="btn btn-sm btn-danger delete-company" data-id="<?php echo e($company->id); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\New folder\finance\resources\views/admin/vehicles/index.blade.php ENDPATH**/ ?>