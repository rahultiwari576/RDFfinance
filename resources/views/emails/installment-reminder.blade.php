    ...
    <div class="content">
        ...
        <div class="details-box">
            ...
            <div class="detail-row">
                ...
                <span class="detail-value"><strong>{{ $installment->due_date->format('F d, Y') }}</strong></span>
            </div>
            
            <div class="detail-row">
                <span class="detail-label">EMI Amount:</span>
                <span class="detail-value">₹{{ number_format($installment->amount, 2) }}</span>
            </div>
            
            @if($installment->penalty_amount > 0)
            <div class="detail-row">
                <span class="detail-label">Penalty Amount:</span>
                <span class="detail-value" style="color: #dc3545;">₹{{ number_format($installment->penalty_amount, 2) }}</span>
            </div>
            @endif
            ...
            <div class="detail-row" style="background: #f0f0f0; padding: 15px; margin: 10px -20px -20px -20px; border-radius: 0 0 5px 5px;">
                ...
                <span class="amount-highlight">₹{{ number_format($totalAmount, 2) }}</span>
            </div>
        </div>
        ...
        <div class="details-box">
            ...
            <div class="detail-row">
                ...
                <span class="detail-value">
                    <span style="padding: 5px 10px; background: {{ $loan->status === 'active' ? '#28a745' : '#6c757d' }}; color: white; border-radius: 3px;">
                        {{ ucfirst($loan->status) }}
                    </span>
                </span>
            </div>
        ...
        <p style="text-align: center;">
            <a href="{{ config('app.url') }}/home" class="button">Make Payment Now</a>
        </p>
